...
export const WORD_LIST = [
  ...
  // short phonics words missing from base list
  "tea","tee","fee","wee","foe","hoe","roe","lay","char","torn","char","fray","pray","slay","sway","bray","gray","gray","clay","play","stay","stray","spray","stray",
  "plea","flea","rhea","urea","idea","area",
  "rye","dye","lye","bye","aye",
  "awe","ewe","owe",
